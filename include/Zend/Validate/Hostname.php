 ...
 */
require_once 'include/Zend/Validate/Ip.php';

/**
 * Please note there are two standalone test scripts for testing IDN characters due to problems
 * with file encoding.
 *
 * The first is tests/include/Zend/Validate/HostnameTestStandalone.php which is designed to be run on
 * the command line.
 *
 * The second is tests/include/Zend/Validate/HostnameTestForm.php which is designed to be run via HTML
...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        ...
        'CN'  => 'Hostname/Cn.php',
        'COM' => 'include/Zend/Validate/Hostname/Com.php',
        ...
        'HK'  => 'include/Zend/Validate/Hostname/Cn.php',
        ...
        'JP'  => 'include/Zend/Validate/Hostname/Jp.php',
        ...
        'NET' => 'include/Zend/Validate/Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
        'NU'  => 'include/Zend/Validate/Hostname/Com.php',
        ...
        'TW'  => 'include/Zend/Validate/Hostname/Cn.php',
        ...
        '中国' => 'include/Zend/Validate/Hostname/Cn.php',
        '公司' => 'include/Zend/Validate/Hostname/Cn.php',
        '网络' => 'include/Zend/Validate/Hostname/Cn.php'
    );
