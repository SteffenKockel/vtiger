 ...
 * Zend_Gdata_Feed
 */
require_once 'include/Zend/Gdata/App/Feed.php';

/**
 * Zend_Gdata_Http_Client
 */
require_once 'include/Zend/Http/Client.php';
 ...
 */
require_once 'include/Zend/Gdata/App/MediaSource.php';

/**
 * Zend_Uri/Http
 */
require_once 'include/Zend/Uri/Http.php';
...
class Zend_Gdata_App
{
                                   ...
                                   $contentTypeOverride = null)
    {
        ...
        // Fix for Contacts
        if (strpos($url, "/m8/feeds/contacts") !== false && $method == "DELETE") {
            $headers['If-Match'] = '*';
        }
        // END
    ...
    {
        require_once 'include/Zend/Http/Client/Exception.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once 'include/Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once 'include/Zend/Gdata/HttpAdapterStreamingSocket.php';
